...
public:
	...
	{}
	//конструктор с двумя аргументов
...
int main()
{
	...
	int position;
	card card1(7, clubs);            //определение и инцилизация card1
	cout << "\nКарта 1: ";
	card1.display();             //вывод card1
	card card2(jack, hearts);        //определение и инцилизация card2
	cout << "\nКарта 2: ";
	card2.display();             //вывод card2
	card card3(ace, spades);        //определение и инцилизация card3
	cout << "\nКарта 3: ";
	card3.display();             //вывод card3
	prize = card3;                  //карту prize не обходима угадать
	...
	chosen.display();                             //вывод выбранноц карты
	cout << endl;
	return 0;
}